...
class AssociationSpec extends ObjectBehavior
{
    ...
    function it_can_read_association_line()
    {
        $this->startsWith()->shouldBe('{"JsonAssociationV1"');
    }

    function it_can_get_line_from_schedule_file()
    {
        $this->get(function($association) {
            expect($association)->shouldBeAnyOf([
                self::ASSOCIATION_L1,
                self::ASSOCIATION_L2
            ]);
        });
    ...
    private function scheduleFileContent()
    {
        return [
            ...
            self::ASSOCIATION_L1,
            self::ASSOCIATION_L2,
            '{"TiplocV1":{"transaction_type":"Create","tiploc_code":"ABCWM","nalco":"385964","stanox":"78128","crs_code":null,"description":null,"tps_description":"ABERCWMBOI"}}',
